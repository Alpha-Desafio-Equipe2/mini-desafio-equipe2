...
_(dependendo da porta configurada)_
...
│   │   │
│   │   ├── medicine/
│   │   │    └── 20240102_create_medicines.ts
│   │   │
│   │   ├── customer/
│   │   │    └── 20240103_create_customers.ts
│   │   │
│   │   ├── doctor/
│   │   │    └── 20240104_create_doctors.ts
│   │   │
│   │   └── sale/
│   │        ├── 20240105_create_sales.ts
│   │        └── 20240106_create_item_sales.ts
│   │
│   └── seeds/               # opcional
│        └── initial_data.ts
│
